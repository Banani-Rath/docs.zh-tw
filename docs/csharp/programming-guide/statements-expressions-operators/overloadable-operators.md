...
|[&&](../../../csharp/language-reference/operators/conditional-and-operator.md), [&#124;&#124;](../../../csharp/language-reference/operators/conditional-or-operator.md)|雖然條件式邏輯運算子無法多載，但它們可以使用 `&` 和                               `&#124;` 進行評估 \(可多載\)。|  
