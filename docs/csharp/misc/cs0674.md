---
title: "編譯器錯誤 CS0674 | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
請勿使用 'System.ParamArrayAttribute'。 請改用 'params' 關鍵字。  
 ...
 C\# 編譯器不允許使用 <xref:System.ParamArrayAttribute?displayProperty=fullName>；請改用 [params](../../csharp/language-reference/keywords/params.md)。  
