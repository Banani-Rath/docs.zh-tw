...
事件 'event' 只可以出現在 \+\= 或 \-\= 左邊  
 ...
 未正確地呼叫[事件](../../csharp/language-reference/keywords/event.md)。 如需詳細資訊，請參閱[事件](../../csharp/programming-guide/events/index.md)與[委派](../../csharp/programming-guide/delegates/index.md)。  
