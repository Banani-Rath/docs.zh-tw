...
`Microsoft.VisualBasic` 命名空間含有構成 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 執行階段程式庫的類別、模組、常數和列舉型別。  這些程式庫成員會提供可在程式碼中使用的程序、屬性和常數值。  每個模組與類別各代表一種特定的功能分類。  
  
## Microsoft.VisualBasic.Collection 類別  
...
## Microsoft.VisualBasic.ComClassAttribute 類別  
...
## Microsoft.VisualBasic.ControlChars 類別  
...
## Microsoft.VisualBasic.Constants 類別  
...
## Microsoft.VisualBasic.Conversion 模組  
...
## Microsoft.VisualBasic.DateAndTime 模組  
...
## Microsoft.VisualBasic.ErrObject 類別  
...
## Microsoft.VisualBasic.FileSystem 模組  
...
## Microsoft.VisualBasic.Financial 模組  
...
## Microsoft.VisualBasic.Globals 模組  
...
## Microsoft.VisualBasic.HideModuleNameAttribute 類別  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## Microsoft.VisualBasic.Information 模組  
...
## Microsoft.VisualBasic.Interaction 模組  
...
## Microsoft.VisualBasic.MyGroupCollectionAttribute 類別  
...
## Microsoft.VisualBasic.Strings 模組  
...
## Microsoft.VisualBasic.VBFixedArrayAttribute 類別  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## Microsoft.VisualBasic.VBFixedStringAttribute 類別  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## Microsoft.VisualBasic.VbMath 模組  
  
|||||  
|-|-|-|-|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## Microsoft.VisualBasic 常數和列舉型別  
 `Microsoft.VisualBasic` 命名空間會提供屬於 [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] 執行階段程式庫一部分的常數和列舉型別。  您可以在程式碼中使用這些常數值。  每個列舉型別都代表一種特定的功能分類。  如需詳細資訊，請參閱 [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md)。  
