...
|動作|語言項目|  
|--------|----------|  
|指派值。|[Get](../../../visual-basic/language-reference/statements/get-statement.md)、[Property](../../../visual-basic/language-reference/statements/property-statement.md)|  
...
|需要明確變數宣告。|[Option Explicit](../../../visual-basic/language-reference/statements/option-explicit-statement.md)、[Option Strict](../../../visual-basic/language-reference/statements/option-strict-statement.md)|  
