...
|動作|語言項目|  
|--------|----------|  
|取得目前日期或時間。|<xref:Microsoft.VisualBasic.DateAndTime.Now%2A>, <xref:Microsoft.VisualBasic.DateAndTime.Today%2A>, <xref:Microsoft.VisualBasic.DateAndTime.TimeOfDay%2A>|  
...
|處理序計時。|<xref:Microsoft.VisualBasic.DateAndTime.Timer%2A>|  
