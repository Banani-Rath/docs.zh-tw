...
## 在本節中  
 ...
 示範如何在設計階段和執行階段使用 <xref:Microsoft.VisualBasic.PowerPacks.LineShape> 控制項來繪製線條。  
  
 [How to: Draw Shapes with the OvalShape and RectangleShape Controls](../../../visual-basic/developing-apps/windows-forms/how-to-draw-shapes-with-the-ovalshape-and-rectangleshape-controls.md)  
 示範如何在設計階段和執行階段使用 <xref:Microsoft.VisualBasic.PowerPacks.OvalShape> 和 <xref:Microsoft.VisualBasic.PowerPacks.RectangleShape> 控制項來繪製圖案。  
