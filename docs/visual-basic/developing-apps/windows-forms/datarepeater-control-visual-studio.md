...
## 在本節中  
 ...
 介紹並討論 `DataRepeater` 控制項。  
  
 [How to: Display Bound Data in a DataRepeater Control](../../../visual-basic/developing-apps/windows-forms/how-to-display-bound-data-in-a-datarepeater-control-visual-studio.md)  
 示範如何使用 `DataRepeater` 控制項來顯示資料來源的資料。  
 ...
 示範如何使用 `DataRepeater` 控制項來顯示其他資料。  
 ...
 示範如何變更 `DataRepeater` 控制項的方向。  
  
 [How to: Change the Appearance of a DataRepeater Control](../../../visual-basic/developing-apps/windows-forms/how-to-change-the-appearance-of-a-datarepeater-control-visual-studio.md)  
 示範如何在設計階段和執行階段自訂 `DataRepeater` 控制項。  
 ...
 示範如何在 `DataRepeater` 控制項上控制選取範圍指標。  
 ...
 示範如何防止使用者加入或刪除 `DataRepeater` 控制項中的項目。  
 ...
 示範如何使用兩個 `DataRepeater` 控制項來顯示相關的記錄。  
