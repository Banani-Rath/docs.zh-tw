...
-   如果您想要隱藏或遮蔽隱含的基底類別成員，請在屬性的宣告中以 [Shadows](../../visual-basic/language-reference/modifiers/shadows.md) 關鍵字取代 [Overloads](../../visual-basic/language-reference/modifiers/overloads.md) 關鍵字。  
